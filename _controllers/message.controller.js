...
const messageController = {
    ...
    addMessageGroupe:async (req,res)=>{
      try{
        const { idExpediteur, idConversation } = req.params;
        ...
        valideData.idConversation = idConversation;

        const addMessage = await messageService.addToMessage(
          valideData,
          idExpediteur,
          idConversation
        )
